#include <iostream>
/*Convertir de numero arabico a romano*/
int main()
{
    ...
    numero /= 10;          // 1234/10=123.4
    decenas = numero % 10; // 12.3==3

    numero /= 10;           // 123/10=12.3
    centenas = numero % 10; // 12/10=1.2==2

    millares = numero / 10; // 12==1.2
